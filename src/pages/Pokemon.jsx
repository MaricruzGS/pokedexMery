...
const Pokemon = () => {
  ...
  return (
    <main className="pokemonId__main">
      <section className="pokemonId">
        ...
        <section className="pokemonId__fuatures">
          ...
          <div className="pokemonId__info--container">
            ...
            <div className="pokemonId__info--data">
              ...
              dataPokemon?.types.map(type => 
                <p className={`pokemonId__info--value bg-${type.type.name}`} key={type.type.name}>{type.type.name}</p>
              )
              }
            </div>
          </div>
            ...
            dataPokemon?.stats.map(stat => ( 
              <div className="pokemonId__stat" key={stat.stat.name}>
                ...
                <div className="pokemonId__stat--bar">
                  <div style={{width: getPercentBar(stat.base_stat)}} className="pokemonId__stat--barProgress"></div>
                </div>
              </div>
            ))
            }
